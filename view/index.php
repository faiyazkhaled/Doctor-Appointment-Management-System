...
<html lang="en">
    ...
    <body class ="bg-black">
        ...
        <nav class="navbar navbar-default navbar-fixed-top" role="navigation">
            <div class="container-fluid">
                ...
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="index.php"><img alt="Brand" src="assets/img/logosss.jpg" height="48px"></a>
                </div>
        ...
        <div class="copyright-bar bg-black">
            <div class="container">
                <p class="pull-left small"><a href =""></a></p>
                <p class="pull-right small"><a href="../controller/adminlogin.php">admin</a></p>
            </div>
        </div>
        <!-- footer end -->
    </div>
