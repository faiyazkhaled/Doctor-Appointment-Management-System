<?php
session_start();
include_once '../controller/assets/conn/dbconnect.php';
					...
					<ul class="nav navbar-nav navbar-right">
						<li class="dropdown">
							...
							<ul class="dropdown-menu">
								...
								<li class="divider"></li>
								<li>
									<a href="../controller/patientlogout.php?logout"><i class="fa fa-fw fa-power-off"></i> Log Out</a>
								</li>
							</ul>
						</li>
					</ul>
				...
				<div class="row">
					<div class="col-xs-12 col-md-8">
						...
						echo "<div class='row'>";
							...
							?>
							<!-- notification end -->
							<h2>Hello <?php echo $userRow['patientFirstName']; ?> <?php echo $userRow['patientLastName']; ?>. Feel free to make an appointment!</h2>
						...
						xmlhttp.open("GET","../controller/getschedule.php?q="+str,true);
						console.log(str);
						xmlhttp.send();
						}
						}
