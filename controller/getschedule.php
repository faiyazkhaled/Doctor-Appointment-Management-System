...
if (!$res) {
die("Error running $sql: " . mysqli_error(die));
}
?>
<!DOCTYPE html>
<html lang="en">
        ...
        echo "   <table class='table table-hover'>";
            ...
            echo "  <tbody>";
                ...
                <tr>
                    ...
                    echo "<td><a href='../controller/appointment.php?&appid=" . $row['scheduleId'] . "&scheduleDate=".$q."' class='btn btn-".$btnclick." btn-xs' role='button' ".$btnstate.">Book Now</a></td>";
                    // echo "<td><a href='../controller/appointment.php?&appid=" . $row['scheduleId'] . "&scheduleDate=".$q."'>Book</a></td>";
